    ...
    <div class="container-fluid">
        <div class="row">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <a href="index.php?page=tambah_cuaca" type="button" class="btn btn-primary mb-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; white-space:nowrap;">
                                        ...
                                        <a href="index.php?page=ubah_cuaca&id=<?=$row['id'];?>" class="btn btn-success btn-sm" role="button" title="Ubah Data"><i class="fas fa-edit"></i></a>
                                        <a href="proses/cuaca/proses_hapus_cuaca.php?id=<?=$row['id'];?>" class="btn btn-danger btn-sm" role="button" title="Hapus Data" onclick="return confirm('Apakah anda yakin?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                <!-- Modal -->
